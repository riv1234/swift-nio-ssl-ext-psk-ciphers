...
public struct NIOTLSCipher: RawRepresentable, Hashable {
    ...
    public static let TLS_RSA_PSK_WITH_AES_128_CBC_SHA                = NIOTLSCipher(rawValue: 0x0094)
    public static let TLS_RSA_PSK_WITH_AES_256_CBC_SHA                = NIOTLSCipher(rawValue: 0x0095)
    public static let TLS_RSA_PSK_WITH_AES_256_GCM_SHA384             = NIOTLSCipher(rawValue: 0x00AD)
